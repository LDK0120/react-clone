...
export default function Nav() {
    ...
    return (
        ...
        <div className="nav-items">
          ...
          <a className="item" id="item-one" href="/" rel="noreferrer">NEWS</a>
          <a className="item" href="//press.hulu.com/guides/">GUIDES</a>
          <a className="item" href="//press.hulu.com/schedule/february-2022/" rel="noreferrer">SCHEDULE</a>
